  ...
  return (
    <div className="w-full h-full flex flex-col justify-around items-center relative z-20">
      <form className="nm-flat-white-sm rounded-lg p-8 flex flex-col items-stretch gap-5 group/form">
        ...
        <Link className="nm-flat-slate-200-sm text-black group-valid/form:nm-flat-blue-base-sm group-valid/form:text-white transition-all duration-500 text-center px-4 py-2 rounded" type="button" to="/gestion/stock">
          Connexion
        </Link>
